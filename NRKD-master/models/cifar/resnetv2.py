...
__all__ = ['resnet152', 'resnet50', 'resnet101', 'resnet34', 'resnet18']
...
class ResNet(nn.Module):
    ...
    def forward(self, x, is_feat=False, preact=False):
        ...
        # print(out[1], f1_pre[1])
        f1 = out
        out, f2_pre = self.layer2(out)
        # print(out.size(), f2_pre.size())
        f2 = out
        out, f3_pre = self.layer3(out)
        # print(out.size(), f3_pre.size())
        f3 = out
        out, f4_pre = self.layer4(out)
        # print(out.size(), f4_pre.size())
        f4 = out
